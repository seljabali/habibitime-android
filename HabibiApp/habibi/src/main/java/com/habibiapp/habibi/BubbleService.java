...
public class BubbleService extends Service {
    ...
    private void copyPhrase(final View anchor, final Phrase phrase) {
        ...
        if (copyType == 1) {
            copyToClipboard(arabicTranslatedPhrase.getNativePhraseSpelling());
        } else if (copyType == 2) {
            copyToClipboard(arabicTranslatedPhrase.getPhoneticPhraseSpelling());
        } else if (copyType == 3) {
            copyToClipboard(arabicTranslatedPhrase.getProperPhoneticPhraseSpelling());
        }
        popup.dismiss();
    }
